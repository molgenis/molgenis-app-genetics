...
@Component
public class GavinDiagJobExecutionMetaData extends SystemEntityType
{
	private final JobExecutionMetaData jobExecutionMetaData;

	private static final String SIMPLE_NAME = "GavinDiagJobExecution";
	public static final String GAVIN_DIAG_JOB_EXECUTION = PACKAGE_INDEX + PACKAGE_SEPARATOR + SIMPLE_NAME;
	...
	@Autowired
	public GavinDiagJobExecutionMetaData(IndexPackage indexPackage, JobExecutionMetaData jobExecutionMetaData)
	{
	...
	public void init()
	{
		setLabel("Gavin Diagnostics job execution");
