...
describe('VariantTable.vue', () => {
  ...
  it('renders component exactly like this', () => {
    ...
    const expectedData = '<div><div class="justify-content-centermy-1 row"><div class="col-6 offset-md-6 form-group row"><label class="col-form-label col-sm-2">Filter</label><div class="col-sm-10"><input type="text" id="b_4" rows="1" placeholder="Type to Search" class="form-control"><!----><!----></div></div></div> <table class="table table-hover"><thead><tr><th class="">Chromosome</th><th class="">Gene</th><th class="">cDNA</th><th class="">Protein change</th><th class="">Gavin Reason</th></tr></thead><tbody><tr class=""><td class="">1</td><td class="">BRCA1</td><td class="">A&gt;T</td><td class="">Arg&gt;His</td><td class="">Pathogenic because test</td></tr><tr class=""><td class="">2</td><td class="">BRCA2</td><td class="">C&gt;G</td><td class="">Lys&gt;Ala</td><td class="">Benign because test</td></tr></tbody></table></div>'
